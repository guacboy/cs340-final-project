...
const sales = ref([
  {
    ...
    saleDate: '2025-06-20',
    saleDetails: [
      { saleID: 1, productID: 1, quantity: 4, salePrice: 5.00 },
    ],
    totalRevenue: 20.00,
  },
  {
    ...
    saleDate: '2025-06-24',
    saleDetails: [
      { saleID: 2, productID: 1, quantity: 1, salePrice: 5.00 },
  ...
  },
  {
    ...
    saleDate: '2025-06-27',
    saleDetails: [
      { saleID: 3, productID: 3, quantity: 2, salePrice: 7.25 },
    ],
    totalRevenue: 14.50,
  },
])
          ...
          <template v-for="s in sales" :key="s.saleID">
            ...
            <tr @click="toggleExpand(s.saleID)" class="cursor-pointer hover:bg-(--base)">
              ...
              <td class="px-4 py-2 text-right space-x-2">
                <button @click.stop="onEdit(s.saleID)" class="cursor-pointer px-1 py-1 bg-(--secondary) text-black rounded-sm hover:bg-(--secondary-light) transition">
                  <Pencil />
                </button>
                <button @click.stop="onRemove(s.saleID)" class="cursor-pointer px-1 py-1 bg-(--primary) text-black rounded-sm hover:bg-(--primary-light) transition">
                  <X />
                </button>
              </td>
            </tr>
